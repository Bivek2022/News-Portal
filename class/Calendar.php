	...
	class Calendar
	{
		...
		public function eng_to_nep($yy, $mm, $dd)
		{
			...
			else
			{
				...
				$numDay = $day;
				$this->_nep_date['year']    = $this->changeNumToNep((string)$y);
				$this->_nep_date['month']   = $this->changeNumToNep((string)$m);
				$this->_nep_date['date']    = $this->changeNumToNep((string)$total_nDays);
				$this->_nep_date['day']     = $this->_get_day_of_week($day);
				$this->_nep_date['nmonth']  = $this->_get_nepali_month($m);
				$this->_nep_date['num_day'] = $this->changeNumToNep((string)$numDay);;
		...
		public function changeNumToNep($number){
			$converted_num = "";
